...
if (WIN32)
	set(RapidJSON_ROOT_DIR "${ENGINE_ROOT_DIR}/ThirdParty/rapidjson" CACHE PATH "RapidJSON root directory")
	...
	if (PKG_RapidJSON_FOUND)
		...
		set(INCLUDE_HINTS "${ENGINE_ROOT_DIR}/ThirdParty/rapidjson/include")
	endif()
endif()
