...
if (WIN32)
	...
	find_library(BulletCollision_LIBRARY NAMES BulletCollision  HINTS "${Bullet_ROOT_DIR}/lib/Release/")
	find_library(BulletDynamics_LIBRARY NAMES BulletDynamics  HINTS "${Bullet_ROOT_DIR}/lib/Release/")
	find_library(LinearMath_LIBRARY NAMES LinearMath  HINTS "${Bullet_ROOT_DIR}/lib/Release/")
	find_library(Bullet3Collision_LIBRARY NAMES Bullet3Collision  HINTS "${Bullet_ROOT_DIR}/lib/Release/")
	find_library(Bullet3Common_LIBRARY NAMES Bullet3Common  HINTS "${Bullet_ROOT_DIR}/lib/Release/")
	find_library(Bullet3Dynamics_LIBRARY NAMES Bullet3Dynamics  HINTS "${Bullet_ROOT_DIR}/lib/Release/")
	find_library(Bullet3Geometry_LIBRARY NAMES Bullet3Geometry HINTS "${Bullet_ROOT_DIR}/lib/Release/")
else()
