set(SANITIZERS_PROCESSED false) #flag used to emit warnings only once
...
#function(sanitize_target sanitization_target)
	...
	if(ENABLED_SANITIZERS_LEN GREATER 1)
		...
		#message(STATUS "Enabled sanitizers: ${ENABLED_SANITIZERS} (for target ${sanitization_target}).")
	endif()
