...
class	btIDebugDraw
{
	...
	virtual void drawTransform(const btTransform& transform, btScalar orthoLen)
	{
		...
		drawLine(start, start+transform.getBasis() * btVector3(orthoLen, 0.f, 0.f), btVector3(1.f, 0.3f, 0.3f));
		drawLine(start, start+transform.getBasis() * btVector3(0.f, orthoLen, 0.f), btVector3(0.3f, 1.f, 0.3f));
		drawLine(start, start+transform.getBasis() * btVector3(0.f, 0.f, orthoLen), btVector3(0.3f, 0.3f, 1.f));
	}
