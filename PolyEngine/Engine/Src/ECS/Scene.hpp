...
namespace Poly {
	...
	public:
		...
		/// <summary>Gets a component of a specified type from entity with given ::pe::core::UniqueID.</summary>
		...
		::pe::core::memory::IterablePoolAllocatorBase* GetComponentAllocator(size_t componentID) 
		{
		...
		::pe::core::memory::IterablePoolAllocator<Entity>& GetEntityAllocator() { return EntitiesAllocator; }
		...
		private:
			...
			explicit ComponentIterator(typename ::pe::core::memory::IterablePoolAllocator<PrimaryComponent>::Iterator parent, Scene* const w) : primary_iter(parent), 
			...
			typename ::pe::core::memory::IterablePoolAllocator<PrimaryComponent>::Iterator primary_iter;
			typename ::pe::core::memory::IterablePoolAllocator<PrimaryComponent>::Iterator Begin;
			typename ::pe::core::memory::IterablePoolAllocator<PrimaryComponent>::Iterator End;
		};
	...
	private:
		...
		void AddComponent(Entity* entity, Args&&... args)
		{
			...
			HEAVY_ASSERTE(!entity->HasComponent(ctypeID), "Failed at AddComponent() - a component of a given ::pe::core::UniqueID already exists!");
		...
		void RemoveComponent(Entity* entity)
		{
			const auto ctypeID = GetComponentID<T>();
			HEAVY_ASSERTE(entity, "Invalid entity ID");
			HEAVY_ASSERTE(entity->HasComponent(ctypeID), "Failed at RemoveComponent() - a component of a given ::pe::core::UniqueID does not exist!");
		...
		//------------------------------------------------------------------------------
		template<typename T>
		::pe::core::memory::IterablePoolAllocator<T>* GetComponentAllocator()
		{
			const auto ctypeID = GetComponentID<T>();
			return static_cast<::pe::core::memory::IterablePoolAllocator<T>*>(GetComponentAllocator(ctypeID));
		}
		...
		// Allocators
		::pe::core::memory::IterablePoolAllocator<Entity> EntitiesAllocator;
		::pe::core::memory::IterablePoolAllocatorBase* ComponentAllocators[MAX_COMPONENTS_COUNT];
