...
namespace Poly
{
	...
	public:
		...
		const std::vector<::pe::core::math::Vector3f>& GetPositions() const { return Positions; }
		const std::vector<::pe::core::math::Vector3f>& GetNormals() const { return Normals; }
		const std::vector<::pe::core::math::Vector3f>& GetTangents() const { return Tangents; }
		const std::vector<::pe::core::math::Vector3f>& GetBitangents() const { return Bitangents; }
		...
		const std::vector<::pe::core::math::VectorT<i8, 4>>& GetBoneIds() const { return BoneIds; }
		const std::vector<::pe::core::math::VectorT<float, 4>>& GetBoneWeights() const { return BoneWeights; }
	...
	private:
		...
		std::vector<::pe::core::math::Vector3f> Positions;
		std::vector<::pe::core::math::Vector3f> Normals;
		std::vector<::pe::core::math::Vector3f> Tangents;
		std::vector<::pe::core::math::Vector3f> Bitangents;
		std::vector<TextCoord> TextCoords;
		std::vector<uint32_t> Indices;
		std::vector<::pe::core::math::VectorT<i8, 4>> BoneIds; // Max 4 bones
		std::vector<::pe::core::math::VectorT<float, 4>> BoneWeights;
