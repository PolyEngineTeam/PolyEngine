...
namespace Poly
{
	...
	ENGINE_DLLEXPORT ::pe::core::storage::String EvaluateFullResourcePath(eResourceSource Source, const ::pe::core::storage::String& path);

	ENGINE_DLLEXPORT ::pe::core::storage::String LoadTextFileRelative(eResourceSource Source, const ::pe::core::storage::String& path);
	ENGINE_DLLEXPORT void SaveTextFileRelative(eResourceSource Source, const ::pe::core::storage::String& path, const ::pe::core::storage::String& text);
...
#define DEFINE_RESOURCE(type, map_name) namespace Poly { namespace Impl { std::map<::pe::core::storage::String, std::unique_ptr<type>> map_name = {}; }}
	...
	public:
		...
		static T* Load(const ::pe::core::storage::String& path, eResourceSource source, Args&&... args)
		{
			...
			// Load the resource
			T* resource = nullptr;
			::pe::core::storage::String absolutePath = gAssetsPathConfig.GetAssetsPath(source) + path;
