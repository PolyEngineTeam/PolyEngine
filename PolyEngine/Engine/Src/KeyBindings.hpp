...
namespace Poly
{
    enum class eControllerAxis
    {
        ...
        AXIS_LX = SDL_CONTROLLER_AXIS_LEFTX,
        AXIS_LY = SDL_CONTROLLER_AXIS_LEFTY,
        AXIS_RX = SDL_CONTROLLER_AXIS_RIGHTX,
        AXIS_RY = SDL_CONTROLLER_AXIS_RIGHTY,
        AXIS_LT = SDL_CONTROLLER_AXIS_TRIGGERLEFT,
        AXIS_RT = SDL_CONTROLLER_AXIS_TRIGGERRIGHT,
        _COUNT = SDL_CONTROLLER_AXIS_MAX,
    };
	enum class eControllerButton
	{
		...
		BUTTON_LS = SDL_CONTROLLER_BUTTON_LEFTSTICK,
		BUTTON_RS = SDL_CONTROLLER_BUTTON_RIGHTSTICK,
		...
		_COUNT = SDL_CONTROLLER_BUTTON_MAX,
	};
