...
namespace Poly
{
	//TODO add bindings for Command button
	enum class eKey
	{
		UNDEFINED              = 0x00,
		MLBUTTON               = 0xfe, //No mouse buttons in codes, adding own code
		MRBUTTON               = 0xfd, //No mouse buttons in codes, adding own code
		CANCEL                 = UNDEFINED, // What?
		MMBUTTON               = 0xfc, //No mouse buttons in codes, adding own code
		MBUTTON1               = UNDEFINED, //No such mouse buttons in codes
		MBUTTON2               = UNDEFINED, //No such mouse buttons in codes
		BACKSPACE              = 0x33,
		TAB                    = 0x30,
		CLEAR                  = UNDEFINED, //Nope
		ENTER                  = 0x24, //Return key, not the NumPad Enter
		SHIFT                  = 0x38,
		CTRL                   = 0x3b,
		ALT                    = 0x3a, // This is option key
		PAUSE                  = UNDEFINED,
		CAPS_LOCK              = 0x39,
		IME_KANA               = 0x68,
		IME_HANGUL             = UNDEFINED, //Nope
		IME_JUNJA              = UNDEFINED,
		IME_FINAL              = UNDEFINED,
		IME_HANJE              = UNDEFINED,
		IME_KENJI              = UNDEFINED,
		ESCAPE                 = 0x35,
		IME_CONVERT            = UNDEFINED,
		IME_NONCONVERT         = UNDEFINED,
		IME_ACCEPT             = UNDEFINED,
		IME_MODECHANGE         = UNDEFINED,
		SPACE                  = 0x31,
		PAGE_UP                = 0x74,
		PAGE_DOWN              = 0x79,
		END                    = 0x77,
		...
		PRINT                  = UNDEFINED,
		EXECUTE                = UNDEFINED, //???
		SNAPSHOT               = UNDEFINED, //that's Print Screen/SysRq, yo
		INS                    = UNDEFINED,
		DEL                    = 0x75, // This is forward delete (I hope so)
		HELP                   = 0x72,
		KEY_0                  = 0x1d,
		KEY_1                  = 0x12,
		KEY_2                  = 0x13,
		...
		KEY_Y                  = 0x10,
		KEY_Z                  = 0x06,
		LWIN                   = 0x37, //This is L command key
		RWIN                   = 0x36, // This is R command key
		APPS                   = UNDEFINED, //Nope
		SLEEP                  = UNDEFINED, //Nope
		NUM_0                  = 0x52,
		NUM_1                  = 0x53,
		NUM_2                  = 0x54,
		NUM_3                  = 0x55,
		...
		NUM_SUBTRACT           = 0x4e,
		NUM_DECIMAL            = 0x41,
		NUM_DIVIDE             = 0x4b, //where is NUM_EQUALS or NUM_ENTER ?
		F1                     = 0x7a,
		F2                     = 0x78,
		F3                     = 0x63,
		F4                     = 0x76,
		...
		F19                    = 0x50,
		F20                    = 0x5a,
		F21                    = UNDEFINED, // No more F keys on mac keyboard
		F22                    = UNDEFINED,
		F23                    = UNDEFINED,
		F24                    = UNDEFINED,
		NUM_LOCK               = UNDEFINED, // Nope
		SCROLL_LOCK            = UNDEFINED, // Nope
		LSHIFT                 = 0x38,
		RSHIFT                 = 0x3c,
		LCTRL                  = 0x3b,
		RCTRL                  = 0x3e,
		LMENU                  = UNDEFINED, // Nope
		RMENU                  = UNDEFINED,
		BROWSER_BACK           = UNDEFINED,
		BROWSER_FORWARD        = UNDEFINED,
		BROWSER_REFRESH        = UNDEFINED,
		BROWSER_STOP           = UNDEFINED, // Nope
		BROWSER_SEARCH         = UNDEFINED,
		BROWSER_FAVORITES      = UNDEFINED,
		BROWSER_HOME           = UNDEFINED,
		VOLUME_MUTE            = 0x4a,
		VOLUME_DOWN            = 0x49,
		VOLUME_UP              = 0x48,
		MEDIA_NEXT             = UNDEFINED,
		MEDIA_PREV             = UNDEFINED,
		MEDIA_STOP             = UNDEFINED,
		MEDIA_PLAY_PAUSE       = UNDEFINED,
		LAUNCH_MAIL            = UNDEFINED, //:(
		LAUNCH_MEDIA_SELECT    = UNDEFINED,
		LAUNCH_APP1            = UNDEFINED,
		LAUNCH_AP2             = UNDEFINED,
		SEMICOLON_COLON        = 0x29,
		PLUS                   = 0x18, // WTF, is this equals key?
		COMMA                  = 0x2b,
		MINUS                  = 0x1b,
		PERIOD                 = 0x2f,
		SLASH_QUESTION         = 0x2c,
		TILDE                  = 0x32,
		OPEN_SQUARE_CURLY      = 0x21,
		BACKSLASH_VERTICAL_BAR = 0x2a,
		CLOSE_SQUARE_CURLY     = 0x1e,
		QUOTE_SINGLE_DOUBLE    = 0x27,
		OEM_8                  = UNDEFINED, //?
		OEM_102                = UNDEFINED,
