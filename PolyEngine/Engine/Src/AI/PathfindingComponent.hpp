...
namespace Poly
{
	...
	public:
		...
		virtual ::pe::core::math::Vector GetNodeWorldPosition(const Poly::NavNode* node) const = 0;
		virtual const NavNode* GetNodeFromWorldPosition(const ::pe::core::math::Vector& pos) const = 0;
	...
	public:
		...
		void SetDestination(const ::pe::core::math::Vector& pos);
		void ResetDestination();

		inline const std::vector<::pe::core::math::Vector>& GetPath() const { return CalculatedPath; }
	private:
		const NavGraph* NavigationGraph = nullptr;
		std::vector<::pe::core::math::Vector> CalculatedPath;
		std::optional<::pe::core::math::Vector> CurentDestination;
