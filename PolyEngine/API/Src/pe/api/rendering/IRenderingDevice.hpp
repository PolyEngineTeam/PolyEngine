...
namespace rendering {
	...
	{
	public:
		virtual void SetContent(const ::pe::engine::res::Mesh& mesh) = 0;
		virtual unsigned int GetResourceID() const = 0;
	};
	...
	{
	public:
		virtual void Resize(const core::math::Vector2i& size) = 0;
		virtual const core::math::Vector2i& GetScreenSize() const = 0;

		virtual void RenderWorld(ecs::Scene* world) = 0;
		virtual void Init() = 0;
