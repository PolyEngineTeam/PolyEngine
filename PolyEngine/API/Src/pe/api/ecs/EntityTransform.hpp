...
namespace pe::api::ecs 
{
	...
	class API_DLLEXPORT EntityTransform final : public ::Poly::RTTIBase
	{
		RTTI_DECLARE_TYPE_DERIVED(::pe::api::ecs::EntityTransform, ::Poly::RTTIBase)
		{
			...
			RTTI_PROPERTY_AUTONAME(LocalTranslation, ::Poly::RTTI::ePropertyFlag::NONE);
			RTTI_PROPERTY_AUTONAME(LocalRotation, ::Poly::RTTI::ePropertyFlag::NONE);
			RTTI_PROPERTY_AUTONAME(LocalScale, ::Poly::RTTI::ePropertyFlag::NONE);
		
			RTTI_PROPERTY_AUTONAME(GlobalTranslation, ::Poly::RTTI::ePropertyFlag::DONT_SERIALIZE);
			RTTI_PROPERTY_AUTONAME(GlobalRotation, ::Poly::RTTI::ePropertyFlag::DONT_SERIALIZE);
			RTTI_PROPERTY_AUTONAME(GlobalScale, ::Poly::RTTI::ePropertyFlag::DONT_SERIALIZE);
			RTTI_PROPERTY_AUTONAME(ParentFromModel, ::Poly::RTTI::ePropertyFlag::DONT_SERIALIZE);
			RTTI_PROPERTY_AUTONAME(WorldFromModel, ::Poly::RTTI::ePropertyFlag::DONT_SERIALIZE);
			RTTI_PROPERTY_AUTONAME(LocalDirty, ::Poly::RTTI::ePropertyFlag::DONT_SERIALIZE);
			RTTI_PROPERTY_AUTONAME(GlobalDirty, ::Poly::RTTI::ePropertyFlag::DONT_SERIALIZE);
		}
	public:
