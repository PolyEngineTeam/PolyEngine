...
TEST_CASE("Vector constructors", "[Vector]") {
  // empty constructor
  ::pe::core::math::Vector v1;
  REQUIRE(v1.X == 0);
  REQUIRE(v1.Y == 0);
  REQUIRE(v1.Z == 0);

  // basic constructor
  ::pe::core::math::Vector v2(1, 2, 3);
  REQUIRE(v2.X == 1);
  REQUIRE(v2.Y == 2);
  REQUIRE(v2.Z == 3);

  // copy constructor
  ::pe::core::math::Vector v3(v2);
  REQUIRE(v3.X == 1);
  REQUIRE(v3.Y == 2);
  REQUIRE(v3.Z == 3);
...
TEST_CASE("Vector comparison operators", "[Vector]") {
  ...
  SECTION("Vector negation operator") {
    REQUIRE(-v1 == ::pe::core::math::Vector(-1,-2,-3));
    REQUIRE(-(-v1) == v1);
  }
}

TEST_CASE("Vector-Vector operators", "[Vector]") {
  ::pe::core::math::Vector v1(3, 4, 6);
  ::pe::core::math::Vector v2(1, 2, 3);
  ::pe::core::math::Vector v3;
  
  SECTION("Vector sum operator") {
	  ::pe::core::math::Vector v4(4, 6, 9);
	  REQUIRE(v1 + v2 == v4);
	  REQUIRE(v2 + v1 == v4);
  ...
  SECTION("Vector subtraction operator") {
	  REQUIRE(v1 - v2 == ::pe::core::math::Vector(2, 2, 3));
	  REQUIRE(v2 - v1 == ::pe::core::math::Vector(-2, -2, -3));
...
TEST_CASE("Vector-scalar operators", "[Vector]") {
	::pe::core::math::Vector v1(1, 2, 3);
	::pe::core::math::Vector v2(v1);
	float s1 = 2;

	SECTION("Multiplication operator") {
		REQUIRE(v1*s1 == ::pe::core::math::Vector(2, 4, 6));
		v2 *= s1;
		REQUIRE(v2 == v1*s1);
	}

	SECTION("Division operator") {
		REQUIRE(v1 / s1 == ::pe::core::math::Vector(0.5f, 1.0f, 1.5f));
		v2 /= s1;
		REQUIRE(v2 == v1 / s1);
	}

	SECTION("Sum operator") {
		REQUIRE(v1 + s1 == ::pe::core::math::Vector(3.0f, 4.0f, 5.0f));
		v2 += s1;
		REQUIRE(v2 == v1 + s1);
	}

	SECTION("Subtraction operator") {
		REQUIRE(v1 - s1 == ::pe::core::math::Vector(-1.0f, 0.0f, 1.0f));
		v2 -= s1;
		REQUIRE(v2 == v1 - s1);
	}
}
...
TEST_CASE("Vector algebraic methods", "[Vector]") {
  ...
  SECTION("Vector cross product") {
    ::pe::core::math::Vector v3 = v1.Cross(v2);
    REQUIRE(v3 == ::pe::core::math::Vector(0, 3, -2));
  ...
  SECTION("Normalization") {
	  ::pe::core::math::Vector v3 = v1;
	  v3.Normalize();
	  float l = v1.Length();
	  REQUIRE(v3 == v1 / l);
	  ::pe::core::math::Vector v4 = v1.GetNormalized();
	  REQUIRE(v4 == v3);
