...
TEST_CASE("Vector2f constructors", "[Vector2f]") {
	// empty constructor
	core::math::Vector2f v1;
	REQUIRE(v1.X == 0);
	REQUIRE(v1.Y == 0);

	// basic constructor
	core::math::Vector2f v2(1, 2);
	REQUIRE(v2.X == 1);
	REQUIRE(v2.Y == 2);

	// copy constructor
	core::math::Vector2f v3(v2);
	REQUIRE(v3.X == 1);
	REQUIRE(v3.Y == 2);
...
TEST_CASE("Vector2f comparison operators", "[Vector2f]") {
	...
	SECTION("Vector2f negation operator") {
		REQUIRE(-v1 == core::math::Vector2f(-1, -2));
		REQUIRE(-(-v1) == v1);
	}
}

TEST_CASE("Vector2f-Vector2f operators", "[Vector2f]") {
	core::math::Vector2f v1(3, 4);
	core::math::Vector2f v2(1, 2);
	core::math::Vector2f v3;

	SECTION("Vector2f sum operator") {
		core::math::Vector2f v4(4, 6);
		REQUIRE(v1 + v2 == v4);
		REQUIRE(v2 + v1 == v4);
	...
	SECTION("Vector2f subtraction operator") {
		REQUIRE(v1 - v2 == core::math::Vector2f(2, 2));
		REQUIRE(v2 - v1 == core::math::Vector2f(-2, -2));
	...
	SECTION("Vector2f multiplication operator") {
		REQUIRE(v1*v1 == core::math::Vector2f(9, 16));
		v3 = v2;
		v3 *= v2;
		REQUIRE(v3 == v2 * v2);
	}
	...
	SECTION("Vector2f division operator") {
		REQUIRE(v1 / v2 == core::math::Vector2f(3.0f, 2.0f));
		v3 = v1;
		v3 /= v2;
		REQUIRE(v3 == v1 / v2);
	}
...
TEST_CASE("Vector2f-scalar operators", "[Vector2f]") {
	core::math::Vector2f v1(1, 2);
	core::math::Vector2f v2(v1);
	float s1 = 2;

	SECTION("Multiplication operator") {
		REQUIRE(v1*s1 == core::math::Vector2f(2, 4));
		v2 *= s1;
		REQUIRE(v2 == v1*s1);
	}

	SECTION("Division operator") {
		REQUIRE(v1 / s1 == core::math::Vector2f(0.5f, 1.0f));
		v2 /= s1;
		REQUIRE(v2 == v1 / s1);
	}
}
...
TEST_CASE("Vector2f algebraic methods", "[Vector2f]") {
	...
	SECTION("Normalization") {
		core::math::Vector2f v3 = v1;
		v3.Normalize();
		float l = v1.Length();
		REQUIRE(v3 == v1 / l);
		core::math::Vector2f v4 = v1.GetNormalized();
		REQUIRE(v4 == v3);
